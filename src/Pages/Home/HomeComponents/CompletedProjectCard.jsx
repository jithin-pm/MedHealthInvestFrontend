...
import { FiCheckCircle, FiShield, FiExternalLink, FiTarget, FiDollarSign } from 'react-icons/fi'
    ...
    >
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-2">
           ...
           <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#ccff00]">
      ...
      <div className="flex flex-col gap-3 py-4 border-y border-white/5 text-[14px] font-bold text-white">
        <div className="flex items-center justify-between">
          <span className="text-zinc-500 uppercase tracking-widest text-[10px] font-black">Capital Raised :</span>
          <span className="text-white font-black tracking-tight">₹{Number(project.collectedAmount || 0).toLocaleString('en-IN')}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-zinc-500 uppercase tracking-widest text-[10px] font-black">Timeline :</span>
          <span className="text-zinc-100">{project.duration}</span>
        </div>
      </div>
      ...
      <div className="mt-auto pt-1">
        <div className="flex justify-between items-end mb-4">
           ...
           <div className="text-right">
             <span className="text-lg font-black text-[#ccff00] tracking-tighter">
               {project.totalReturn || (project.roi + '%')}
             </span>
             <span className="block text-[8px] font-black uppercase tracking-widest text-zinc-500 leading-none">Final ROI</span>
           </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <button className="group/btn relative w-full py-5 bg-white text-black rounded-2xl text-[12px] font-black tracking-[0.2em] uppercase overflow-hidden active:scale-[0.98] transition-all duration-300 shadow-xl shadow-black/20">
            <span className="relative z-10 flex items-center justify-center gap-2">
              View Audit Report <FiExternalLink className="text-black/40 group-hover/btn:rotate-45 group-hover/btn:text-black transition-all" />
            </span>
